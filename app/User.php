    ...
    public function getStat(){
        ...
        return [
            'all' =>[
                ...
                'properties' => $this->getStatQuery()->count()
            ],
            'today' => [
                ...
                'properties' => $this->getStatQuery()->whereDate('images.updated_at',Date('Y-m-d'))->count()
            ],
            
            'yesterday' => [
                'images' => $this->images()->whereDate('updated_at',$yesterday->format('Y-m-d'))->count(),
                'features' => $this->features()->whereDate('features.updated_at',$yesterday->format('Y-m-d'))->count(),
                'properties' => $this->getStatQuery()->whereDate('images.updated_at',$yesterday->format('Y-m-d'))->count()
            ]
